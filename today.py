...
def svg_overwrite(filename, age_data, commit_data, star_data, repo_data, contrib_data, follower_data, loc_data):
    """
    Parse SVG files and update elements with uptime, commits, stars, repositories, and lines written
    """
...
if __name__ == '__main__':
    """
    Adapted from Andrew Grant (Andrew6rant) SVG profile generator
    for mav1730 (Yash Mishra)
    """
    ...
    # Uptime = time since GitHub account was created (Oct 2024 for mav1730)
